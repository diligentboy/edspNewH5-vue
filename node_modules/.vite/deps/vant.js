...
var ActionBarIcon = withInstall(stdin_default3);

// node_modules/vant/es/action-sheet/ActionSheet.mjs
var [name2, bem2] = createNamespace("action-sheet");
    ...
    const renderHeader = () => {
      if (props2.title) {
        return createVNode("div", {
          ...
          "class": [bem2("close"), HAPTICS_FEEDBACK],
          "onClick": onCancel
        }, null)]);
      }
    };
...
var ActionSheet = withInstall(stdin_default4);

// node_modules/vant/es/picker/utils.mjs
var [name3, bem3, t] = createNamespace("picker");
...
var [name4, bem4] = createNamespace("picker-column");
var PICKER_KEY = Symbol(name4);
...
var [name5] = createNamespace("picker-toolbar");
...
var stdin_default6 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderCancel = () => {
      ...
      return createVNode("button", {
        "type": "button",
        "class": [bem3("cancel"), HAPTICS_FEEDBACK],
        "onClick": onCancel
    ...
    const renderConfirm = () => {
      ...
      return createVNode("button", {
        "type": "button",
        "class": [bem3("confirm"), HAPTICS_FEEDBACK],
        "onClick": onConfirm
...
function useId() {
  ...
  const { name: name102 = "unknown" } = (vm == null ? void 0 : vm.type) || {};
  if (false) {
    return name102;
  }
  return `${name102}-${++current}`;
}
...
var [name6, bem5] = createNamespace("sticky");
var stickyProps = {
  zIndex: numericProp,
...
var Sticky = withInstall(stdin_default7);

// node_modules/vant/es/swipe/Swipe.mjs
var [name7, bem6] = createNamespace("swipe");
var swipeProps = {
  loop: truthProp,
  width: numericProp,
  height: numericProp,
...
var Swipe = withInstall(stdin_default8);

// node_modules/vant/es/tabs/TabsContent.mjs
var [name8, bem7] = createNamespace("tabs");
...
var [name9, bem8] = createNamespace("tabs");
var tabsProps = {
...
var stdin_default10 = defineComponent({
  ...
  setup(props2, {
    ...
    }) : renderHeader() : null, createVNode(stdin_default9, {
      "ref": contentRef,
...
var [name10, bem9] = createNamespace("tab");
...
var [name11, bem10] = createNamespace("swipe-item");
...
var SwipeItem = withInstall(stdin_default11);

// node_modules/vant/es/tab/Tab.mjs
var [name12, bem11] = createNamespace("tab");
...
var stdin_default12 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderTitle = (onClickTab) => createVNode(TabTitle, mergeProps({
      ...
      "onClick": (event) => onClickTab(instance3.proxy, index.value, event)
...
var Tab = withInstall(stdin_default12);

// node_modules/vant/es/tabs/index.mjs
var Tabs = withInstall(stdin_default10);

// node_modules/vant/es/picker-group/PickerGroup.mjs
var [name13, bem12] = createNamespace("picker-group");
var PICKER_GROUP_KEY = Symbol(name13);
...
var stdin_default13 = defineComponent({
  ...
  setup(props2, {
    ...
    return () => {
      ...
      return createVNode("div", {
        "class": bem12()
      }, [props2.showToolbar ? createVNode(stdin_default6, {
        "title": props2.title,
...
var stdin_default14 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderColumnItems = () => currentColumns.value.map((options, columnIndex) => createVNode(stdin_default5, {
    ...
    const renderMask = (wrapHeight) => {
      if (hasOptions.value) {
        ...
        return [createVNode("div", {
          ...
          "class": [BORDER_UNSET_TOP_BOTTOM, bem3("frame")],
          "style": frameStyle
        }, null)];
      }
    };
    ...
    const renderToolbar = () => {
      if (props2.showToolbar && !parent) {
        return createVNode(stdin_default6, mergeProps(pick(props2, pickerToolbarPropKeys), {
          "onConfirm": confirm,
          "onCancel": cancel
...
var Picker = withInstall(stdin_default14);

// node_modules/vant/es/area/Area.mjs
var [name14, bem13] = createNamespace("area");
...
var Area = withInstall(stdin_default15);

// node_modules/vant/es/cell/Cell.mjs
var [name15, bem14] = createNamespace("cell");
var cellSharedProps = {
...
var stdin_default16 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderLabel = () => {
      ...
      if (showLabel) {
        return createVNode("div", {
          "class": [bem14("label"), props2.labelClass]
    ...
    const renderTitle = () => {
      ...
      if (slots.title || isDef(props2.title)) {
        ...
        return createVNode("div", {
          "class": [bem14("title"), props2.titleClass],
    ...
    const renderValue = () => {
      ...
      if (hasValue) {
        return createVNode("div", {
          "class": [bem14("value"), props2.valueClass]
...
var Cell = withInstall(stdin_default16);

// node_modules/vant/es/form/Form.mjs
var [name16, bem15] = createNamespace("form");
var formProps = {
  colon: Boolean,
  disabled: Boolean,
  readonly: Boolean,
...
var Form = withInstall(stdin_default17);
...
var [name17, bem16] = createNamespace("field");
...
var stdin_default18 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderInput = () => {
      const controlClass = bem16("control", [getProp("inputAlign"), {
...
var Field = withInstall(stdin_default18);
...
var [name18, bem17] = createNamespace("toast");
...
var stdin_default19 = defineComponent({
  ...
  setup(props2, {
    ...
    return () => createVNode(Popup, mergeProps({
      "class": [bem17([props2.position, props2.wordBreak === "normal" ? "break-normal" : props2.wordBreak, {
...
function createInstance() {
  const {
    ...
    setup() {
      ...
      const onClosed = () => {
        if (allowMultiple) {
          queue = queue.filter((item) => item !== instance3);
          unmount();
        }
      };
      const render = () => {
        ...
        return createVNode(stdin_default19, mergeProps(state, attrs), null);
      };
      watch(message, (val) => {
        state.message = val;
      });
...
var Toast = withInstall(stdin_default19);

// node_modules/vant/es/switch/Switch.mjs
var [name19, bem18] = createNamespace("switch");
var switchProps = {
  size: numericProp,
  loading: Boolean,
  disabled: Boolean,
...
var Switch = withInstall(stdin_default20);

// node_modules/vant/es/address-edit/AddressEditDetail.mjs
var [name20, bem19] = createNamespace("address-edit-detail");
...
var [name21, bem20, t3] = createNamespace("address-edit");
var DEFAULT_DATA = {
  name: "",
  tel: "",
  city: "",
    ...
    return () => {
      ...
      return createVNode(Form, {
        ...
        default: () => {
          ...
          }, null), [[vShow, props2.showArea]]), createVNode(stdin_default21, {
...
var AddressEdit = withInstall(stdin_default22);

// node_modules/vant/es/radio-group/RadioGroup.mjs
var [name22, bem21] = createNamespace("radio-group");
var radioGroupProps = {
  shape: String,
  disabled: Boolean,
  iconSize: numericProp,
...
var RadioGroup = withInstall(stdin_default23);

// node_modules/vant/es/checkbox-group/CheckboxGroup.mjs
var [name23, bem22] = createNamespace("checkbox-group");
...
var CHECKBOX_GROUP_KEY = Symbol(name23);
...
var CheckboxGroup = withInstall(stdin_default24);

// node_modules/vant/es/tag/Tag.mjs
var [name24, bem23] = createNamespace("tag");
var tagProps = {
  size: String,
  mark: Boolean,
  show: truthProp,
...
var stdin_default26 = defineComponent({
  ...
  setup(props2, {
    ...
    const iconRef = ref();
    const getParentProp = (name102) => {
      if (props2.parent && props2.bindGroup) {
        return props2.parent.props[name102];
      }
    };
...
var [name25, bem24] = createNamespace("radio");
...
var [name26, bem25] = createNamespace("checkbox");
...
var Checkbox = withInstall(stdin_default28);

// node_modules/vant/es/address-list/AddressListItem.mjs
var [name27, bem26] = createNamespace("address-item");
...
var [name28, bem27, t4] = createNamespace("address-list");
...
var stdin_default30 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderItem = (item, index, disabled) => {
      ...
      return createVNode(stdin_default29, {
        "key": item.id,
        "address": item,
        "disabled": disabled,
    ...
    const renderBottom = () => props2.showAddButton ? createVNode("div", {
      "class": [bem27("bottom"), "van-safe-area-bottom"]
    }, [createVNode(Button, {
      "round": true,
      "block": true,
      "type": "primary",
...
var AddressList = withInstall(stdin_default30);
...
var [name29, bem28] = createNamespace("back-top");
var backTopProps = {
  right: numericProp,
  bottom: numericProp,
  zIndex: numericProp,
...
var BackTop = withInstall(stdin_default31);
...
var [name30, bem29] = createNamespace("barrage");
...
var Barrage = withInstall(stdin_default32);

// node_modules/vant/es/calendar/utils.mjs
var [name31, bem30, t5] = createNamespace("calendar");
...
var [name32] = createNamespace("calendar-day");
  ...
  setup(props2, {
    ...
    return () => {
      ...
      return createVNode("div", {
        "role": "gridcell",
        "style": style.value,
        "class": [bem30("day", type), className],
...
var [name33] = createNamespace("calendar-month");
...
var stdin_default34 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderDay = (item, index) => createVNode(stdin_default33, {
      "item": item,
      "index": index,
      "color": props2.color,
...
var [name34] = createNamespace("calendar-header");
...
var Calendar = withInstall(stdin_default36);

// node_modules/vant/es/image/Image.mjs
var [name35, bem31] = createNamespace("image");
var imageProps = {
  src: String,
  alt: String,
  fit: String,
  ...
  setup(props2, {
    ...
    const renderPlaceholder = () => {
      if (loading.value && props2.showLoading) {
        return createVNode("div", {
          "class": bem31("loading")
        }, [renderIcon(props2.loadingIcon, bem31("loading-icon"), slots.loading)]);
      }
      if (error.value && props2.showError) {
        return createVNode("div", {
          "class": bem31("error")
        }, [renderIcon(props2.errorIcon, bem31("error-icon"), slots.error)]);
      }
    };
    const renderImage = () => {
...
var Image2 = withInstall(stdin_default37);

// node_modules/vant/es/card/Card.mjs
var [name36, bem32] = createNamespace("card");
var cardProps = {
  tag: String,
  num: numericProp,
  desc: String,
...
var stdin_default38 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderTitle = () => {
      ...
      if (props2.title) {
        return createVNode("div", {
          "class": [bem32("title"), "van-multi-ellipsis--l2"]
        }, [props2.title]);
      }
    };
...
var Card = withInstall(stdin_default38);

// node_modules/vant/es/cascader/Cascader.mjs
var [name37, bem33, t6] = createNamespace("cascader");
var cascaderProps = {
  title: String,
  options: makeArrayProp(),
  closeable: truthProp,
...
var stdin_default39 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderHeader = () => props2.showHeader ? createVNode("div", {
      ...
      "name": props2.closeIcon,
      "class": [bem33("close-icon"), HAPTICS_FEEDBACK],
      "onClick": onClose
    }, null) : null]) : null;
...
var Cascader = withInstall(stdin_default39);

// node_modules/vant/es/cell-group/CellGroup.mjs
var [name38, bem34] = createNamespace("cell-group");
var cellGroupProps = {
  title: String,
  inset: Boolean,
  border: truthProp
...
var CellGroup = withInstall(stdin_default40);

// node_modules/vant/es/circle/Circle.mjs
var [name39, bem35] = createNamespace("circle");
var uid = 0;
...
var Circle = withInstall(stdin_default41);

// node_modules/vant/es/row/Row.mjs
var [name40, bem36] = createNamespace("row");
var ROW_KEY = Symbol(name40);
var rowProps = {
  tag: makeStringProp("div"),
  wrap: truthProp,
  align: String,
...
var [name41, bem37] = createNamespace("col");
var colProps = {
  tag: makeStringProp("div"),
...
var Col = withInstall(stdin_default43);

// node_modules/vant/es/collapse/Collapse.mjs
var [name42, bem38] = createNamespace("collapse");
var COLLAPSE_KEY = Symbol(name42);
var collapseProps = {
  border: truthProp,
  accordion: Boolean,
  modelValue: {
...
var Collapse = withInstall(stdin_default44);

// node_modules/vant/es/collapse-item/CollapseItem.mjs
var [name43, bem39] = createNamespace("collapse-item");
...
var CollapseItem = withInstall(stdin_default45);

// node_modules/vant/es/config-provider/index.mjs
var ConfigProvider = withInstall(stdin_default);

// node_modules/vant/es/contact-card/ContactCard.mjs
var [name44, bem40, t7] = createNamespace("contact-card");
...
var stdin_default46 = defineComponent({
  ...
  setup(props2, {
    ...
    return () => createVNode(Cell, {
      ...
      "class": bem40([props2.type]),
      "border": false,
      "isLink": props2.editable,
      "titleClass": bem40("title"),
      "onClick": onClick
    }, {
      title: renderContent
    });
...
var ContactCard = withInstall(stdin_default46);

// node_modules/vant/es/contact-edit/ContactEdit.mjs
var [name45, bem41, t8] = createNamespace("contact-edit");
var DEFAULT_CONTACT = {
  tel: "",
  name: ""
};
...
var ContactEdit = withInstall(stdin_default47);

// node_modules/vant/es/contact-list/ContactList.mjs
var [name46, bem42, t9] = createNamespace("contact-list");
...
var stdin_default48 = defineComponent({
  ...
  setup(props2, {
    ...
    return () => createVNode("div", {
      ...
      "class": [bem42("bottom"), "van-safe-area-bottom"]
    }, [createVNode(Button, {
      "round": true,
      "block": true,
      "type": "primary",
...
var ContactList = withInstall(stdin_default48);
...
var [name47, bem43] = createNamespace("count-down");
var countDownProps = {
...
var CountDown = withInstall(stdin_default49);
...
var [name48, bem44, t10] = createNamespace("coupon");
...
var Coupon = withInstall(stdin_default50);

// node_modules/vant/es/coupon-cell/CouponCell.mjs
var [name49, bem45, t11] = createNamespace("coupon-cell");
var couponCellProps = {
  title: String,
  border: truthProp,
  editable: truthProp,
...
var CouponCell = withInstall(stdin_default51);

// node_modules/vant/es/empty/Empty.mjs
var [name50, bem46] = createNamespace("empty");
var emptyProps = {
...
var Empty = withInstall(stdin_default52);

// node_modules/vant/es/coupon-list/CouponList.mjs
var [name51, bem47, t12] = createNamespace("coupon-list");
var couponListProps = {
  code: makeStringProp(""),
  coupons: makeArrayProp(),
  currency: makeStringProp("¥"),
...
var CouponList = withInstall(stdin_default53);

// node_modules/vant/es/date-picker/DatePicker.mjs
var currentYear = (/* @__PURE__ */ new Date()).getFullYear();
var [name52] = createNamespace("date-picker");
...
var DatePicker = withInstall(stdin_default54);

// node_modules/vant/es/divider/Divider.mjs
var [name53, bem48] = createNamespace("divider");
var dividerProps = {
  dashed: Boolean,
  hairline: truthProp,
  vertical: Boolean,
...
var Divider = withInstall(stdin_default55);

// node_modules/vant/es/dropdown-menu/DropdownMenu.mjs
var [name54, bem49] = createNamespace("dropdown-menu");
...
var DROPDOWN_KEY = Symbol(name54);
...
var [name55, bem50] = createNamespace("dropdown-item");
...
var DropdownItem = withInstall(stdin_default57);

// node_modules/vant/es/dropdown-menu/index.mjs
var DropdownMenu = withInstall(stdin_default56);
...
var [name56, bem51] = createNamespace("floating-bubble");
var stdin_default58 = defineComponent({
  ...
  setup(props2, {
    ...
    const updateState = () => {
      ...
      state.value = {
        x: offset2 ? offset2.x : windowWidth.value - width - gapX.value,
        y: offset2 ? offset2.y : windowHeight.value - height - gapY.value,
        width,
        height
      };
    };
    ...
    return () => {
      const Content = withDirectives(createVNode("div", mergeProps({
        ...
        "style": rootStyle.value
      }, attrs), [slots.default ? slots.default() : createVNode(stdin_default2, {
        "name": props2.icon,
        "class": bem51("icon")
...
var FloatingBubble = withInstall(stdin_default58);
...
var [name57, bem52] = createNamespace("floating-panel");
...
var FloatingPanel = withInstall(stdin_default59);

// node_modules/vant/es/grid/Grid.mjs
var [name58, bem53] = createNamespace("grid");
var gridProps = {
  square: Boolean,
  center: truthProp,
  border: truthProp,
...
var Grid = withInstall(stdin_default60);

// node_modules/vant/es/grid-item/GridItem.mjs
var [name59, bem54] = createNamespace("grid-item");
...
var stdin_default61 = defineComponent({
  ...
  setup(props2, {
    ...
    return () => {
      ...
      const classes = [bem54("content", [direction, {
        center,
        square,
        reverse,
        clickable,
...
var GridItem = withInstall(stdin_default61);

// node_modules/vant/es/highlight/Highlight.mjs
var [name60, bem55] = createNamespace("highlight");
var highlightProps = {
      ...
      return highlightChunks.value.map((chunk) => {
        ...
        if (highlight) {
          return createVNode(highlightTag, {
            "class": [bem55("tag"), highlightClass]
          }, {
            default: () => [text]
          });
        }
...
var Highlight = withInstall(stdin_default62);
...
var bem56 = createNamespace("image-preview")[1];
...
var stdin_default63 = defineComponent({
  ...
  setup(props2, {
    ...
    return () => {
      ...
      return createVNode(SwipeItem, {
        "ref": swipeItem,
        "class": bem56("swipe-item"),
        "onTouchstartPassive": onTouchStart,
        "onTouchend": onTouchEnd,
        "onTouchcancel": onTouchEnd
      }, {
        default: () => [slots.image ? createVNode("div", {
          "class": bem56("image-wrap")
        }, [slots.image({
          src: props2.src,
          onLoad,
...
var [name61, bem57] = createNamespace("image-preview");
...
var stdin_default64 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderImages = () => createVNode(Swipe, {
      ...
      default: () => [props2.images.map((image, index) => createVNode(stdin_default63, {
        "ref": (item) => {
    ...
    const renderClose = () => {
      if (props2.closeable) {
        return createVNode(Icon, {
          "role": "button",
          "name": props2.closeIcon,
          "class": [bem57("close-icon", props2.closeIconPosition), HAPTICS_FEEDBACK],
          "onClick": emitClose
        }, null);
      }
    };
    ...
    return () => createVNode(Popup, mergeProps({
      "class": [bem57(), props2.className],
      "overlayClass": [bem57("overlay"), props2.overlayClass],
      "onClosed": onClosed,
      "onUpdate:show": updateShow
...
var ImagePreview = withInstall(stdin_default64);
...
var [name62, bem58] = createNamespace("index-bar");
var indexBarProps = {
  sticky: truthProp,
  zIndex: numericProp,
  teleport: [String, Object],
...
var INDEX_BAR_KEY = Symbol(name62);
...
var [name63, bem59] = createNamespace("index-anchor");
...
var IndexAnchor = withInstall(stdin_default66);

// node_modules/vant/es/index-bar/index.mjs
var IndexBar = withInstall(stdin_default65);

// node_modules/vant/es/list/List.mjs
var [name64, bem60, t13] = createNamespace("list");
var listProps = {
  error: Boolean,
    ...
    const renderLoading = () => {
      if (loading.value && !props2.finished && !props2.disabled) {
        return createVNode("div", {
          ...
          "class": bem60("loading-icon")
        }, {
          default: () => [props2.loadingText || t13("loading")]
        })]);
      }
    };
...
var List = withInstall(stdin_default67);

// node_modules/vant/es/nav-bar/NavBar.mjs
var [name65, bem61] = createNamespace("nav-bar");
var navBarProps = {
  title: String,
  fixed: Boolean,
  zIndex: numericProp,
...
var stdin_default68 = defineComponent({
  ...
  setup(props2, {
    ...
    const navBarRef = ref();
    const renderPlaceholder = usePlaceholder(navBarRef, bem61);
    ...
    const renderNavBar = () => {
      ...
      return createVNode("div", {
        ...
        "class": [bem61("title"), "van-ellipsis"]
...
var NavBar = withInstall(stdin_default68);

// node_modules/vant/es/notice-bar/NoticeBar.mjs
var [name66, bem62] = createNamespace("notice-bar");
var noticeBarProps = {
  text: String,
  mode: String,
  color: String,
...
var NoticeBar = withInstall(stdin_default69);

// node_modules/vant/es/notify/Notify.mjs
var [name67, bem63] = createNamespace("notify");
...
var stdin_default70 = defineComponent({
  ...
  setup(props2, {
    ...
    const updateShow = (show) => emit("update:show", show);
    return () => createVNode(Popup, mergeProps({
      "class": [bem63([props2.type]), props2.className],
      "style": {
        color: props2.color,
        background: props2.background
      },
...
var currentOptions2 = getDefaultOptions();
var closeNotify = () => {
  if (instance2) {
    instance2.toggle(false);
  }
};
function showNotify(options) {
  ...
  options = extend({}, currentOptions2, parseOptions2(options));
  instance2.open(options);
  clearTimeout(timer);
...
var setNotifyDefaultOptions = (options) => extend(currentOptions2, options);
var resetNotifyDefaultOptions = () => {
  currentOptions2 = getDefaultOptions();
};

// node_modules/vant/es/notify/index.mjs
var Notify = withInstall(stdin_default70);

// node_modules/vant/es/number-keyboard/NumberKeyboardKey.mjs
var [name68, bem64] = createNamespace("key");
var CollapseIcon = createVNode("svg", {
  "class": bem64("collapse-icon"),
  "viewBox": "0 0 30 24"
}, [createVNode("path", {
...
var [name69, bem65] = createNamespace("number-keyboard");
...
var stdin_default72 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderKeys = () => keys.value.map((key) => {
      ...
      return createVNode(stdin_default71, {
        "key": key.text,
        "text": key.text,
        "type": key.type,
        "wider": key.wider,
    ...
    const renderSidebar = () => {
      if (props2.theme === "custom") {
        return createVNode("div", {
          "class": bem65("sidebar")
        }, [props2.showDeleteKey && createVNode(stdin_default71, {
          "large": true,
...
var NumberKeyboard = withInstall(stdin_default72);

// node_modules/vant/es/pagination/Pagination.mjs
var [name70, bem66, t14] = createNamespace("pagination");
...
var stdin_default73 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderPrevButton = () => {
      ...
      }, [slot ? slot() : props2.prevText || t14("prev")])]);
    };
    const renderNextButton = () => {
      ...
      return createVNode("li", {
        ...
        "disabled": disabled,
        "onClick": () => updateModelValue(modelValue + 1, true)
      }, [slot ? slot() : props2.nextText || t14("next")])]);
    };
...
var Pagination = withInstall(stdin_default73);

// node_modules/vant/es/password-input/PasswordInput.mjs
var [name71, bem67] = createNamespace("password-input");
  ...
  setup(props2, {
    ...
    return () => {
      ...
      return createVNode("div", {
        ...
        "class": [bem67("security"), {
          [BORDER_SURROUND]: !props2.gutter
        }],
        "onTouchstartPassive": onTouchStart
      }, [renderPoints()]), info && createVNode("div", {
        "class": bem67(props2.errorInfo ? "error-info" : "info")
      }, [info])]);
    };
  }
});
...
var PasswordInput = withInstall(stdin_default74);

// node_modules/vant/es/picker-group/index.mjs
var PickerGroup = withInstall(stdin_default13);
...
function popperGenerator(generatorOptions) {
  ...
  return function createPopper2(reference, popper, options) {
    ...
    var instance3 = {
      ...
      setOptions: function setOptions(setOptionsAction) {
        ...
        if (true) {
          var modifiers = uniqueBy([].concat(orderedModifiers, state.options.modifiers), function(_ref) {
            var name102 = _ref.name;
            return name102;
          });
          validateModifiers(modifiers);
          if (getBasePlacement(state.options.placement) === auto) {
            var flipModifier = state.orderedModifiers.find(function(_ref2) {
              var name102 = _ref2.name;
              return name102 === "flip";
            });
            if (!flipModifier) {
      ...
      forceUpdate: function forceUpdate() {
        ...
        for (var index = 0; index < state.orderedModifiers.length; index++) {
          ...
          var _state$orderedModifie = state.orderedModifiers[index], fn2 = _state$orderedModifie.fn, _state$orderedModifie2 = _state$orderedModifie.options, _options = _state$orderedModifie2 === void 0 ? {} : _state$orderedModifie2, name102 = _state$orderedModifie.name;
    ...
    instance3.setOptions(options).then(function(state2) {
    ...
    function runModifierEffects() {
      state.orderedModifiers.forEach(function(_ref3) {
        var name102 = _ref3.name, _ref3$options = _ref3.options, options2 = _ref3$options === void 0 ? {} : _ref3$options, effect3 = _ref3.effect;
...
function effect(_ref) {
  var state = _ref.state, instance3 = _ref.instance, options = _ref.options;
  var _options$scroll = options.scroll, scroll = _options$scroll === void 0 ? true : _options$scroll, _options$resize = options.resize, resize = _options$resize === void 0 ? true : _options$resize;
  var window2 = getWindow(state.elements.popper);
  var scrollParents = [].concat(state.scrollParents.reference, state.scrollParents.popper);
  if (scroll) {
    scrollParents.forEach(function(scrollParent) {
      scrollParent.addEventListener("scroll", instance3.update, passive);
    });
  }
  if (resize) {
    window2.addEventListener("resize", instance3.update, passive);
  }
  return function() {
    if (scroll) {
      scrollParents.forEach(function(scrollParent) {
        scrollParent.removeEventListener("scroll", instance3.update, passive);
      });
    }
    if (resize) {
      window2.removeEventListener("resize", instance3.update, passive);
    }
  };
}
...
function popperOffsets(_ref) {
  var state = _ref.state, name102 = _ref.name;
  state.modifiersData[name102] = computeOffsets({
...
function applyStyles(_ref) {
  ...
  Object.keys(state.elements).forEach(function(name102) {
    var style = state.styles[name102] || {};
    var attributes = state.attributes[name102] || {};
    var element = state.elements[name102];
...
function effect2(_ref2) {
  ...
  return function() {
    Object.keys(state.elements).forEach(function(name102) {
      var element = state.elements[name102];
      var attributes = state.attributes[name102] || {};
      var styleProperties = Object.keys(state.styles.hasOwnProperty(name102) ? state.styles[name102] : initialStyles[name102]);
...
function offset(_ref2) {
  var state = _ref2.state, options = _ref2.options, name102 = _ref2.name;
  ...
  state.modifiersData[name102] = data;
}
var offset_default = {
  name: "offset",
  enabled: true,
...
var [name72, bem68] = createNamespace("popover");
  ...
  setup(props2, {
    ...
    const renderActionContent = (action, index) => {
      ...
      return [action.icon && createVNode(Icon, {
        "name": action.icon,
        "classPrefix": props2.iconPrefix,
        "class": bem68("action-icon")
      }, null), createVNode("div", {
        "class": [bem68("action-text"), {
    ...
    return () => {
      ...
      return createVNode(Fragment, null, [createVNode("span", {
        ...
        default: () => [props2.showArrow && createVNode("div", {
          ...
          "role": "menu",
          "class": bem68("content", props2.actionsDirection)
...
var Popover = withInstall(stdin_default75);

// node_modules/vant/es/progress/Progress.mjs
var [name73, bem69] = createNamespace("progress");
var progressProps = {
  color: String,
  inactive: Boolean,
  pivotText: String,
...
var Progress = withInstall(stdin_default76);

// node_modules/vant/es/pull-refresh/PullRefresh.mjs
var [name74, bem70, t15] = createNamespace("pull-refresh");
...
var stdin_default77 = defineComponent({
  ...
  setup(props2, {
    ...
    const getStatusText = () => {
      ...
      return props2[`${status}Text`] || t15(status);
    };
    const renderStatus = () => {
      const {
        status,
...
var PullRefresh = withInstall(stdin_default77);

// node_modules/vant/es/rate/Rate.mjs
var [name75, bem71] = createNamespace("rate");
...
var Rate = withInstall(stdin_default78);
...
var [name76, bem72] = createNamespace("rolling-text-item");
...
var [name77, bem73] = createNamespace("rolling-text");
...
var stdin_default80 = defineComponent({
  ...
  setup(props2) {
    ...
    return () => createVNode("div", {
      "class": bem73()
    }, [targetNumArr.value.map((_, i) => createVNode(stdin_default79, {
...
var RollingText = withInstall(stdin_default80);

// node_modules/vant/es/row/index.mjs
var Row = withInstall(stdin_default42);

// node_modules/vant/es/search/Search.mjs
var [name78, bem74, t16] = createNamespace("search");
  ...
  setup(props2, {
    ...
    const renderAction = () => {
      if (props2.showAction) {
        const text = props2.actionText || t16("cancel");
        return createVNode("div", {
          "class": bem74("action"),
          "role": "button",
          "tabindex": 0,
    ...
    return () => {
      ...
      return createVNode("div", {
        ...
        "class": bem74("content", props2.shape)
...
var Search = withInstall(stdin_default81);

// node_modules/vant/es/share-sheet/ShareSheet.mjs
var isImage = (name210) => name210 == null ? void 0 : name210.includes("/");
var popupInheritKeys2 = [...popupSharedPropKeys, "round", "closeOnPopstate", "safeAreaInsetBottom"];
var iconMap = {
  qq: "qq",
  link: "link-o",
  weibo: "weibo",
...
var [name79, bem75, t17] = createNamespace("share-sheet");
...
var stdin_default82 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderIcon = (icon) => {
      if (isImage(icon)) {
        return createVNode("img", {
          "src": icon,
          "class": bem75("image-icon")
        }, null);
      }
      return createVNode("div", {
        "class": bem75("icon", [icon])
      }, [createVNode(Icon, {
    ...
    const renderCancelButton = () => {
      var _a;
      const cancelText = (_a = props2.cancelText) != null ? _a : t17("cancel");
...
var ShareSheet = withInstall(stdin_default82);

// node_modules/vant/es/sidebar/Sidebar.mjs
var [name80, bem76] = createNamespace("sidebar");
var SIDEBAR_KEY = Symbol(name80);
var sidebarProps = {
...
var Sidebar = withInstall(stdin_default83);

// node_modules/vant/es/sidebar-item/SidebarItem.mjs
var [name81, bem77] = createNamespace("sidebar-item");
...
var SidebarItem = withInstall(stdin_default84);

// node_modules/vant/es/signature/Signature.mjs
var [name82, bem78, t18] = createNamespace("signature");
var signatureProps = {
  tips: String,
...
var stdin_default85 = defineComponent({
  ...
  setup(props2, {
    ...
    return () => createVNode("div", {
      ...
      default: () => [props2.clearButtonText || t18("clear")]
    }), createVNode(Button, {
      "size": "small",
      "onClick": undo
    }, {
      default: () => [props2.undoButtonText || t18("undo")]
    }), createVNode(Button, {
      "type": "primary",
      "size": "small",
      "onClick": submit
    }, {
      default: () => [props2.confirmButtonText || t18("confirm")]
    })])]);
  }
});

// node_modules/vant/es/signature/index.mjs
var Signature = withInstall(stdin_default85);

// node_modules/vant/es/skeleton-title/SkeletonTitle.mjs
var [name83, bem79] = createNamespace("skeleton-title");
...
var SkeletonTitle = withInstall(stdin_default86);
var stdin_default87 = SkeletonTitle;

// node_modules/vant/es/skeleton-avatar/SkeletonAvatar.mjs
var [name84, bem80] = createNamespace("skeleton-avatar");
...
var stdin_default88 = defineComponent({
  ...
  setup(props2) {
    return () => createVNode("div", {
      "class": bem80([props2.avatarShape]),
...
var SkeletonAvatar = withInstall(stdin_default88);
var stdin_default89 = SkeletonAvatar;
...
var [name85, bem81] = createNamespace("skeleton-paragraph");
...
var SkeletonParagraph = withInstall(stdin_default90);
var stdin_default91 = SkeletonParagraph;

// node_modules/vant/es/skeleton/Skeleton.mjs
var [name86, bem82] = createNamespace("skeleton");
...
var stdin_default92 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderAvatar = () => {
      if (props2.avatar) {
        return createVNode(stdin_default89, {
    ...
    const renderTitle = () => {
      if (props2.title) {
        return createVNode(stdin_default87, {
          "round": props2.round,
    ...
    const renderRows = () => Array(+props2.row).fill("").map((_, i) => createVNode(stdin_default91, {
      "key": i,
      "round": props2.round,
...
var Skeleton = withInstall(stdin_default92);

// node_modules/vant/es/skeleton-image/SkeletonImage.mjs
var [name87, bem83] = createNamespace("skeleton-image");
...
var SkeletonImage = withInstall(stdin_default93);

// node_modules/vant/es/slider/Slider.mjs
var [name88, bem84] = createNamespace("slider");
var sliderProps = {
  ...
  setup(props2, {
    ...
    const getButtonClassName = (index) => {
      if (typeof index === "number") {
        ...
        return bem84(`button-wrapper`, position[index]);
      }
      return bem84("button-wrapper", props2.reverse ? "left" : "right");
    };
...
var Slider = withInstall(stdin_default94);

// node_modules/vant/es/space/Space.mjs
var [name89, bem85] = createNamespace("space");
var spaceProps = {
  align: String,
  direction: {
    type: String,
...
var Space = withInstall(stdin_default95);

// node_modules/vant/es/steps/Steps.mjs
var [name90, bem86] = createNamespace("steps");
var stepsProps = {
  active: makeNumericProp(0),
...
var [name91, bem87] = createNamespace("step");
var stdin_default97 = defineComponent({
  ...
  setup(props2, {
    ...
    return () => {
      ...
      return createVNode("div", {
        "class": [BORDER, bem87([parentProps.direction, {
          [status]: status
        }])]
      }, [createVNode("div", {
        "class": bem87("title", {
...
var Step = withInstall(stdin_default97);

// node_modules/vant/es/stepper/Stepper.mjs
var [name92, bem88] = createNamespace("stepper");
...
var Stepper = withInstall(stdin_default98);

// node_modules/vant/es/steps/index.mjs
var Steps = withInstall(stdin_default96);

// node_modules/vant/es/submit-bar/SubmitBar.mjs
var [name93, bem89, t19] = createNamespace("submit-bar");
var submitBarProps = {
  tip: String,
  label: String,
  price: Number,
  ...
  setup(props2, {
    ...
    const renderText = () => {
      ...
      if (typeof price === "number") {
        ...
        return createVNode("div", {
          ...
          "class": bem89("price-integer")
        }, [pricePair[0]]), decimal]), suffixLabel && createVNode("span", {
          "class": bem89("suffix-label")
        }, [suffixLabel])]);
      }
    };
    const renderTip = () => {
      ...
      if (slots.tip || tip) {
        return createVNode("div", {
          ...
          "class": bem89("tip-icon"),
          "name": tipIcon
        }, null), tip && createVNode("span", {
          "class": bem89("tip-text")
    ...
    const renderButton = () => {
      ...
      return createVNode(Button, {
        ...
        "class": bem89("button", props2.buttonType),
...
var SubmitBar = withInstall(stdin_default99);

// node_modules/vant/es/swipe-cell/SwipeCell.mjs
var [name94, bem90] = createNamespace("swipe-cell");
var swipeCellProps = {
  name: makeNumericProp(""),
  disabled: Boolean,
...
var SwipeCell = withInstall(stdin_default100);

// node_modules/vant/es/tabbar/Tabbar.mjs
var [name95, bem91] = createNamespace("tabbar");
var tabbarProps = {
  route: Boolean,
  fixed: truthProp,
  border: truthProp,
...
var stdin_default101 = defineComponent({
  ...
  setup(props2, {
    ...
    const renderPlaceholder = usePlaceholder(root, bem91);
...
var Tabbar = withInstall(stdin_default101);

// node_modules/vant/es/tabbar-item/TabbarItem.mjs
var [name96, bem92] = createNamespace("tabbar-item");
...
var TabbarItem = withInstall(stdin_default102);

// node_modules/vant/es/text-ellipsis/TextEllipsis.mjs
var [name97, bem93] = createNamespace("text-ellipsis");
...
var TextEllipsis = withInstall(stdin_default103);

// node_modules/vant/es/time-picker/TimePicker.mjs
var [name98] = createNamespace("time-picker");
...
var [name99, bem94] = createNamespace("tree-select");
var treeSelectProps = {
  max: makeNumericProp(Infinity),
  items: makeArrayProp(),
  ...
  setup(props2, {
    ...
    const renderSidebar = () => {
      const Items = props2.items.map((item) => createVNode(SidebarItem, {
        "dot": item.dot,
        "badge": item.badge,
        "class": [bem94("nav-item"), item.className],
        "disabled": item.disabled,
...
var [name100, bem95, t20] = createNamespace("uploader");
  ...
  setup(props2, {
    ...
    const renderDeleteIcon = () => {
      if (props2.deletable && props2.item.status !== "uploading") {
        ...
        return createVNode("div", {
          ...
          "name": "cross",
          "class": bem95("preview-delete-icon")
        }, null)]);
      }
    };
    const renderCover = () => {
    ...
    const renderPreview = () => {
      ...
      return createVNode("div", {
        ...
        "class": bem95("file-icon"),
        "name": "description"
      }, null), createVNode("div", {
        "class": [bem95("file-name"), "van-ellipsis"]
  ...
  setup(props2, {
    ...
    const renderUpload = () => {
      ...
      return withDirectives(createVNode("div", {
        ...
        "class": bem95("upload-icon")
      }, null), props2.uploadText && createVNode("span", {
        "class": bem95("upload-text")
...
var [name101, bem96] = createNamespace("watermark");
var watermarkProps = {
...
var Watermark = withInstall(stdin_default108);
...
var stdin_default111 = (lazyManager) => ({
  props: {
    src: [String, Object],
    tag: {
      type: String,
...
var Lazyload = {
   ...
   */
  install(app, options = {}) {
    const LazyClass = stdin_default109();
    const lazy = new LazyClass(options);
    const lazyContainer = new LazyContainerManager({ lazy });
    app.config.globalProperties.$Lazyload = lazy;
    if (options.lazyComponent) {
      app.component("LazyComponent", stdin_default110(lazy));
    }
    if (options.lazyImage) {
      app.component("LazyImage", stdin_default111(lazy));
    }
    app.directive("lazy", {
